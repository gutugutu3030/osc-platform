...
| [kotlin-sealed-interface-dispatch](kotlin-sealed-interface-dispatch/) | generated sealed interface と `runtime.on<OscMessages>` を体験 | `./gradlew -p sample/kotlin-sealed-interface-dispatch run` |
...
| kotlin-sealed-interface-dispatch | 19030 | UDP ループバック |
